...
/* custom functions */
string getCode(Node* root, ext_char ch, string result);
HashMap<ext_char, string> charactersToCodes(Node* root);
void traverse(HashMap<ext_char, string>& mapping, Node* root, string recorder);
